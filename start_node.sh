...
#
echo "exec: 
MY_NODE_NAME=\"${MY_NODE_NAME}\" MY_PROCESS_NAME=\"${MY_PROCESS_NAME}\" NODE_RELAY_NUMBER=\"${NODE_RELAY_NUMBER}\" NODE_RELAY_NAME1=\"${NODE_RELAY_NAME1}\" NODE_RELAY_NAME2=\"${NODE_RELAY_NAME2}\" NODE_RELAY_NAME3=\"${NODE_RELAY_NAME3}\"iex \
